...
class HighwayGrayscaleDQNAgent:
    ...
    def update_network(self):
        """Update the policy network using Double DQN"""
...
def main():
    ...
    # Plot progress
    agent.plot_training_progress("training_progress_dqn_grayscale_per_ddqn.png")
    
    # Save model
    agent.save_model("highway_dqn_grayscale_per_ddqn.pth")
    #agent.save_replay_buffer("replay_buffer.pkl")

    # Evaluate agent
    agent.load_model("highway_dqn_grayscale_per_ddqn.pth")

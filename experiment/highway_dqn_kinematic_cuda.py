...
class HighwayKinematicDQNAgent:
    ...
    def __init__(
        ...
        epsilon_end=0.01,
        epsilon_decay=0.995,
        batch_size=512,  # Larger batch for RTX 4090
        target_update_freq=1000,
        buffer_capacity=20000,  # Larger buffer
        fast_skip = False,
...
def main():
    ...
    # Plot progress
    agent.plot_training_progress("training_progress_dqn_kinematic_cuda.png")
    
    # Save model
    agent.save_model("highway_dqn_kinematic_cuda.pth")
    
    # Evaluate agent
    agent.load_model("highway_dqn_kinematic_cuda.pth")
